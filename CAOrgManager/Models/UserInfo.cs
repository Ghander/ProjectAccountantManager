...
namespace CAOrgManager.Models
{
    public partial class UserInfo
    {
        public UserInfo()
        {
            AdmCitiesOcmContact1Navigation = new HashSet<AdmCities>();
            AdmCitiesOcmContact2Navigation = new HashSet<AdmCities>();
        }
        ...
        public virtual AdmCities UsrLocationNavigation { get; set; }
        public virtual ICollection<AdmCities> AdmCitiesOcmContact1Navigation { get; set; }
        public virtual ICollection<AdmCities> AdmCitiesOcmContact2Navigation { get; set; }
    }
}
